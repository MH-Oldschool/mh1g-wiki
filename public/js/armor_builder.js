...
ArmorBuilder.prototype.calculateSkills = function() {
	...
	if (armorSkills.length === 0) {
		...
		if (version == "1") {
			...
			// if (armorSkills.includes("Attack Up [small]") document.getElementById(`attack-stat-${ this.version }`).innerText = "sm";
			// else if (armorSkills.includes("Attack Up [big]") document.getElementById(`attack-stat-${ this.version }`).innerText = "lg";
